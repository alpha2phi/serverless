...
class SageMakerNotebookStruct(core.Struct):
    ...
    def __init__(self, scope: core.Construct, construct_id: str, **kwargs) -> None:
        ...
        # Create S3 bucket
        self.bucket = s3.Bucket(self, "alpha2phi_sm_notebook_s3_bucket", removal_policy=core.RemovalPolicy.DESTROY)
        ...
        core.CfnOutput(self, "Notebook instance name",value=notebook.notebook_instance_name)
